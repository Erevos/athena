...
// ColorRGBf
ColorRGBf::ColorRGBf(const scalar_t r, const scalar_t g, const scalar_t b)
	: m_r(r < 0.f ? 0.f : r),
	  m_g(g < 0.f ? 0.f : g),
	  m_b(b < 0.f ? 0.f : b)
{}
...
// ColorRGBAf
ColorRGBAf::ColorRGBAf(const scalar_t r, const scalar_t g, const scalar_t b, const scalar_t a)
	: m_r(r < 0.f ? 0.f : r),
	  m_g(g < 0.f ? 0.f : g),
	  m_b(b < 0.f ? 0.f : b),
