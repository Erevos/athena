#ifndef ATHENA_IO_LOGMANAGERW_INL
	#define ATHENA_IO_LOGMANAGERW_INL
	...
	namespace athena
	{
		...
		namespace io
		{
			...
			inline void LogManagerW::logMessage( const wchar_t* format , ... )
			{
				va_list arguments;
			...
			inline void LogManagerW::dump_log( const std::wstring& filename , const LogFileOpenMode mode )
			{
			...
			inline void LogManagerW::purge_log()
			{
				_lock.lock(false);
				_manage_log_size();
				_log.clear();
			...
			inline unsigned int LogManagerW::max_log_size() const
			{
			...
			inline std::wstring LogManagerW::auto_dump_filename() const
			{
			...
			inline LogFileOpenMode LogManagerW::auto_dump_file_open_mode() const
			{
			...
			inline std::wostream* LogManagerW::echo_stream() const
			{
				std::wostream* return_value = NULL;
			...
			inline std::wstring LogManagerW::type_separator() const
			{
				std::wstring return_value(L"");
			...
			inline std::wstring LogManagerW::message_separator() const
			{
				std::wstring return_value(L"");
			...
			inline std::wstring LogManagerW::timestamp_separator() const
			{
				std::wstring return_value(L"");
			...
			inline unsigned int LogManagerW::log_size() const
			{
				unsigned int return_value = 0;
			...
			inline std::deque<LogEntryW> LogManagerW::entries( const unsigned int number, const unsigned int start ) const
			{
...
#endif /* ATHENA_IO_LOGMANAGERW_INL */