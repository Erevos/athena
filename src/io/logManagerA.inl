#ifndef ATHENA_IO_LOGMANAGERA_INL
	#define ATHENA_IO_LOGMANAGERA_INL
	...
	namespace athena
	{
		...
		namespace io
		{
			...
			inline void LogManagerA::_post_entry( std::ostream* stream , const LogEntryA& entry )
			{
			...
			inline void LogManagerA::_manage_log_size()
			{
			...
			inline void LogManagerA::_manage_dump_filestream()
			{
			...
			inline void LogManagerA::_log_entry( const LogEntryType& type , const std::string& message )
			{
			...
			inline LogManagerA* LogManagerA::get()
			{
				LogManagerA* return_value = NULL;
			...
			inline void LogManagerA::max_log_size( const unsigned int size )
			{
				_lock.lock(false);
				_max_log_size = size;
				_manage_log_size();
			...
			inline void LogManagerA::auto_dump_filename( const std::string& filename )
			{
				_lock.lock(false);
			...
			inline void LogManagerA::auto_dump_file_open_mode( const LogFileOpenMode mode )
			{
				_lock.lock(false);
			...
			inline void LogManagerA::type_separator( const std::string& separator )
			{
				_lock.lock(false);
			...
			inline void LogManagerA::message_separator( const std::string& separator )
			{
				_lock.lock(false);
			...
			inline void LogManagerA::timestamp_separator( const std::string& separator )
			{
				_lock.lock(false);
			...
			inline void LogManagerA::logMessage( const char* format , ... )
			{
				va_list arguments;
			...
			inline void LogManagerA::dump_log( const std::string& filename , const LogFileOpenMode mode )
			{
			...
			inline void LogManagerA::purge_log()
			{
				_lock.lock(false);
				_manage_log_size();
				_log.clear();
			...
			inline unsigned int LogManagerA::max_log_size() const
			{
			...
			inline std::string LogManagerA::auto_dump_filename() const
			{
			...
			inline LogFileOpenMode LogManagerA::auto_dump_file_open_mode() const
			{
			...
			inline std::ostream* LogManagerA::echo_stream() const
			{
			...
			inline std::string LogManagerA::type_separator() const
			{
				std::string return_value("");
			...
			inline std::string LogManagerA::message_separator() const
			{
				std::string return_value("");
			...
			inline std::string LogManagerA::timestamp_separator() const
			{
				std::string return_value("");
			...
			inline unsigned int LogManagerA::log_size() const
			{
				unsigned int return_value = 0;
			...
			inline std::deque<LogEntryA> LogManagerA::entries( const unsigned int number, const unsigned int start ) const
			{
...
#endif /* ATHENA_IO_LOGMANAGERA_INL */